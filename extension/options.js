...
const els = {
  ...
  askFolder: document.getElementById('ask-folder'),
};
...
async function loadSettings() {
  ...
  els.askFolder.checked = s.askFolder === true;
...
async function init() {
  ...
  els.askFolder.addEventListener('change', () => {
    saveSetting({ askFolder: els.askFolder.checked });
  });
